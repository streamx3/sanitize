...
[doc/HARDWARE-TESTS.md](doc/HARDWARE-TESTS.md) lists what can only be checked on real
hardware. [doc/SHORTCOMINGS.md](doc/SHORTCOMINGS.md) is the full inventory: what gets destroyed without
